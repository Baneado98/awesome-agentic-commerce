...
- [guardian set](https://npm-guardian.vercel.app) - Pre-install supply-chain security for AI coding agents, payable per call in USDC on Base ($0.02), free MCP/HTTP tier, no signup. Four companion x402 + MCP services: [npm-guardian](https://github.com/Baneado98/npm-guardian) (CVEs/OSV.dev, malware, typosquatting), [import-guardian](https://github.com/Baneado98/import-guardian) (hallucinated/slopsquatted imports), [license-guardian](https://github.com/Baneado98/license-guardian) (copyleft/AGPL/SSPL risk), [lockfile-guardian](https://github.com/Baneado98/lockfile-guardian) (lockfile integrity-mismatch & hidden install scripts). Each exposes a `/.well-known/x402-listing` discovery manifest.
